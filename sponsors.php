<!DOCTYPE html>
<html>
<title>Furious Falcons - Sponsors</title>
<meta charset="UTF-8">
      ...
      <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-half w3-margin-bottom">
          <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
            <li class="w3-dark-grey w3-xlarge w3-padding-32">Silver Tier</li>
            <li class="w3-padding-16">Your company's logo on our website</li>
        ...
        <div class="w3-half w3-margin-bottom">
          <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
            <li class="w3-dark-grey w3-xlarge w3-padding-32">Gold Tier</li>
            <li class="w3-padding-16">Your company's logo on our website</li>
            <li class="w3-padding-16">Your company's logo on our competition T-shirts</li>
            <li class="w3-padding-16">_</li>
            <li class="w3-padding-16">_</li>
            <li class="w3-padding-16">
              <h2>$ 500+</h2>
        ...
        <div class="w3-row-padding" style="margin:0 -16px">
          <div class="w3-half w3-margin-bottom">
            <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
              <li class="w3-dark-grey w3-xlarge w3-padding-32">Platinum Tier</li>
              <li class="w3-padding-16">Your company's logo on our website</li>
              <li class="w3-padding-16">Your company's logo on our competition T-shirts</li>
              <li class="w3-padding-16">Your company's logo on our competition robot</li>
              <li class="w3-padding-16">_<br />&nbsp</li>
              <li class="w3-padding-16">
                <h2>$ 2,000+</h2>
                <span class="w3-opacity">Sponsored Amount</span>
              </li>
          ...
          <div class="w3-half w3-margin-bottom">
            <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
              <li class="w3-dark-grey w3-xlarge w3-padding-32">Diamond Tier</li>
              <li class="w3-padding-16">Your company's logo on our website</li>
              <li class="w3-padding-16">Your company's logo on our competition T-shirts</li>
              <li class="w3-padding-16">Your company's logo on our competition robot</li>
              <li class="w3-padding-16">Your company's logo on our major fundraisers, community outreach programs, etc.</li>
              <li class="w3-padding-16">
                <h2>$ 5,000+</h2>
                <span class="w3-opacity">Sponsored Amount</span>
              </li>
        ...
        <h2 class="w3-text-light-grey">Ready to Become a Sponsor?</h2>
